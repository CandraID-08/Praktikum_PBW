...
<body>
   ...
   <div class="container mt-4">
       ...
       <form method="get" class="row g-3 mb-4">
           ...
           <div class="col-md-3">
               <label for="email" class="form-label">Cari Alamat Email</label>
               <input type="email" class="form-control" id="email" name="email" placeholder="Masukkan Alamat Email" value="<?php htmlspecialchars($search_email) ?>">
           </div>
